...
namespace Houssam\Permission;

use Illuminate\Support\Facades\DB;
use Illuminate\Support\ServiceProvider;
use Illuminate\View\Compilers\BladeCompiler;
use Houssam\Permission\Contracts\PermissionInterface as Permission;
use Houssam\Permission\Contracts\RoleInterface as Role;
use Houssam\Permission\Directives\PermissionDirectives;

/**
 * Class PermissionServiceProvider
 * @package Houssam\Permission
 */
