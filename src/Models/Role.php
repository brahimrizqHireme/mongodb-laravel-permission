...
namespace Houssam\Permission\Models;

use Illuminate\Database\Eloquent\Builder;
use Houssam\Permission\Contracts\PermissionInterface;
use Houssam\Permission\Contracts\RoleInterface;
use Houssam\Permission\Exceptions\GuardDoesNotMatch;
use Houssam\Permission\Exceptions\RoleAlreadyExists;
use Houssam\Permission\Exceptions\RoleDoesNotExist;
use Houssam\Permission\Guard;
use Houssam\Permission\Helpers;
use Houssam\Permission\Traits\HasPermissions;
use Houssam\Permission\Traits\RefreshesPermissionCache;
 ...
 * Class Role
 * @property string $_id
 * @package Houssam\Permission\Models
 */
